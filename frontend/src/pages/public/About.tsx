        ...
        <div className="bg-[#0B100E] text-[#F5F1E8] font-[family-name:var(--font-heading)] min-h-screen">
            ...
            <section className="relative z-10 py-16 sm:py-24 px-4 sm:px-6 border-t border-[#202A25]">
                <div className="max-w-6xl mx-auto">
                    ...
                    <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6" staggerDelay={0.08}>
                        {whatWeDo.map((item) => {
            ...
            <section className="relative z-10 py-20 sm:py-32 px-4 sm:px-6 border-t border-[#202A25]">
