export { emailService, EmailService, type SendTransactionalEmailParams, type SendResult } from './emailService.js';
...
export { renderUniversalEmailHtml, renderUniversalEmailText, type UniversalEmailProps } from './components/UniversalEmailTemplate.js';
